...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    function flag() {
        ...
        $text1 = "G.𝐗 𝐇𝐀𝐂𝐊";
        $text2 = "My channel :https://t.me/gxhack200_ok";

        echo "<p style='color: green;'>▂" . str_repeat('▂', 50) . "</p>";
        echo "<p style='color: yellow; text-align: center;'>$text1</p>";
        echo "<hr style='color: red; border: 1px solid;'>";
        echo "<p style='color: yellow; text-align: center;'>$text2</p>";
        echo "<p style='color: green;'>▂" . str_repeat('▂', 50) . "</p>";
